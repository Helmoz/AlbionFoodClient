  ...
  <div>
    <q-item class="q-pa-none">
      ...
      <q-item-section top class="col-xs-3 q-mt-xl">
        <FoodItemPrice :label="`Минимальная цена продажи`" :price="minimalSellPrice" :date="minimalSellPriceDate" />
        <FoodItemPrice :label="`Максимальная цена покупки`" :price="maximumBuyPrice" :date="maximumBuyPriceDate" class="q-mt-md" />
      </q-item-section>
      <q-item-section>
        <FoodItemChart />
      </q-item-section>
